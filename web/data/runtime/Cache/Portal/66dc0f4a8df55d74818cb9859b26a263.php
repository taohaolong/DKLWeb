		...
		<div class="span9">
			...
			<div class="tc-box first-box article-box">
		    	...
		    	<div class="article-infobox">
		    		<span>发布时间:<?php echo ($post_date); ?></span>
					<span>
		    			<a href="javascript:;">阅读量:<span><?php echo ($post_hits); ?></span></a>
...
<!-- Footer
      ...
      <div id="footer">
        ...
        <p>
            Copyright (c) 2005-2025 Deucalion(Beijing) Co., Ltd. All Rights Reserved.<br/>
