...
<div class="container tc-main">
    <div class="row">
        ...
        <form class="form-horizontal J_ajaxForm" name="myform" id="myform" action="<?php echo u('Index/add_post');?>" method="post">

            <div class="control-group">

                <div class="controls"><h3>您第一次使用,请完善您的信息</h3></div>
            </div>
                <div class="table-responsive">
                    <table cellpadding="2" cellspacing="2" width="100%">

                    <tbody>
                    <input type="hidden" class="input" name="cardID" value="<?php echo ($cardID); ?>">
                    <tr>


                        <td>单位编号:</td>
                        <td><input type="text" class="input" name="buss_num" readonly="true"  value="<?php echo ($buss_num); ?>"></td>
                        <td>单位名称:</td>
                        <td><input type="text" class="input" name="buss_name" readonly="true" value="<?php echo ($buss_name); ?>"></td>

                    </tr>
                        <tr>
                            <td>姓名:</td>
                            <td><input type="text" class="input" name="user_name" value=""></td>

                            <td>性别:</td>
                            <td><?php $sexs=array("1"=>"男","2"=>"女"); ?>
                            ...
                            <!--<tr>
                                <td>出生年月:</td>
                            <td>
                                    <input class="J_date" type="text" id="input-birthday" placeholder="2013-01-04"
                                           name="birthday" value="<?php echo ($birthday); ?>"

                            </td>
                            <td>身份证号:</td>
                            <td><input type="text" class="input" name="cardID" value="<?php echo ($cardID); ?>"></td>-->
                        </tr>

                        <tr>
                            <td>联系电话:</td>
                            <td><input type="text" class="input" name="user_tel" value=""></td>
                            <td>电子邮件:</td>
                            <td><input type="text" class="input" name="user_email" value=""></td>
<!--                            <td>现住址:</td>
                            <td><input type="text" class="input" name="user_address" value=""></td>-->


                        <tr>
                        <td>微信:</td>
                        <td><input type="text" class="input" name="user_weichat" value=""></td>

                        <td>QQ:</td>
                            <td><input type="text" class="input" name="user_QQ" value=""></td>
