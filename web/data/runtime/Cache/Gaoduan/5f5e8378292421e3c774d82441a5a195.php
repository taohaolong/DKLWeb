        ...
        <div class="table_list">
            <table width="100%" class="table table-hover">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td><a><?php echo ($vo["gaouserid"]); ?></a></td>
                        ...
                        <td><a href="<?php echo U('Admin/ban',array('id'=>$vo['id']));?>" class="J_ajax_dialog_btn" data-msg="您确定要审核通过此用户吗？"><?php echo ($status[$vo['auth']]); ?></a></td>
